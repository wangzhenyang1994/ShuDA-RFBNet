...
def train():
    ...
    dataset = bdd100k('./image_list/train_images.txt','/cluster/home/it_stu27/bdd100k',512)
    ...
    for iteration in range(start_iter, max_iter):
        ...
        load_t1 = time.time()
        writer.add_scalar("training_loss",loss.item(),iteration+1)
        writer.add_scalar("training_loc_loss",loss_l.item(),iteration+1)
        writer.add_scalar("training_conf_loss",loss_c.item(),iteration+1)
        writer.add_scalar("training_seg_loss",loss_s.item(),iteration+1)
        if iteration % 10 == 0:
        ...
        if iteration % epoch_size == 0:
            ...
            writer.add_scalar("epoch_training_loss",epoch_loss,epoch+1)
